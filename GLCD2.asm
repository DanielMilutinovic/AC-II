;this program displays the status line, stack level labels and menu on the ST7565 GLCD using SPI
...
entry:        LDS #RAMEnd+1                      ;initialise stack pointer, RAMEnd = #0x3FFF (see MC9S12XEP100.inc)
              ...
              JSR dispStatL                      ;display the status line
              
              JSR dispStack                      ;display the 5 stack level labels
              
              JSR dispMenu                       ;display the menu on page 0 of the St7565 GLCD
